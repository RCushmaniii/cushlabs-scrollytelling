<script lang="ts">
  ...
  const content: Record<string, {
    ...
    en: {
      ...
      quote: '"They couldn\'t believe it was a website. They thought it was a professionally produced film."',
    ...
    es: {
      ...
      quote: '"No podian creer que fuera un sitio web. Pensaron que era una pelicula producida profesionalmente."',
