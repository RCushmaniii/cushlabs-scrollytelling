<script lang="ts">
  ...
  const content: Record<string, {
    ...
    en: {
      ...
      quote: '"They couldn\'t believe it was a website. They thought it was not a professionally produced film, but rather an experience."',
      attribution: "— Conservation Project Director, Western Mexico",
      closing: "The full demo was built the same way. That's the level we deliver.",
    ...
    es: {
      ...
      quote: '"No podian creer que fuera un sitio web. Pensaron que no era una pelicula producida profesionalmente, sino una experiencia."',
      attribution: "— Director de Proyecto de Conservacion, Occidente de Mexico",
      closing: "La demo completa fue construida de la misma manera. Ese es el nivel que entregamos.",
